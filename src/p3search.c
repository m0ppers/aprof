...
/*
 * Definition der Benutzeroberfl�che
 */

// Breite des Fensters (H�he wird berechnet)
...
// Suchstring (mu� bei Programmende freigegeben werden)
...
/*
 *
 * Moduldestruktor f�r p3search.c
 *
 */ 
...
/* DlgSearchLayout
 *
 * Gadgetpositionen und -h�hen werden berechnet
 */
static ULONG DlgSearchLayout( struct NewGadget *gl )
{
   ...
   /* Berechnung der Gadgeth�he in Abh�ngigkeit vom default font 
    * (1.5 * Zeilenh�he)
    */

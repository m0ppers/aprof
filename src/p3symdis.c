...
/* Auslesen des ToolType f�r Speicherung des Pattern
 */
...
/*******************
 * Die folgenden Funktionen geh�ren zum Sortiersystem
 */

// Argumente f�r p3Cmp, nicht besser m�glich
...
/**************************************************************
 * Tabellenwerte & Datendefinitionen f�r Sortierung
 *
 * Alle Tabellen m�ssen parallel laufen
 */
...
/********************
 * Funktionsdefinitionen f�r Anzeigeeinheit
 */
...
/**************************************************************
 * Tabellen & Datendefinitionen f�r Anzeigeeinheit
 *
...
/* GetEinheitToolType
 *
 * Auslesen des ToolType f�r die eingestellte Einheit
 */
...
/*************************************************************************
 * ClearSymList - Falls angezeigte Symbolliste vorhanden, dann l�schen
 */
...
/*************************************************************************
 * ShowSymbolList - �bergibt eine neue Symbolliste an dsp.o
 *
...
void ShowSymbolList( void )
{
   ...
   /* Text in ProfileBase einh�ngen und darstellen
